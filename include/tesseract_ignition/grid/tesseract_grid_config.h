 ...
 *
*/
#ifndef TESSERACT_IGNITION_TESSERACT_GRID_CONFIG_H
#define TESSERACT_IGNITION_TESSERACT_GRID_CONFIG_H
#include <memory>
...
namespace plugins
{
  ...
  class TesseractGridConfig : public ignition::gui::Plugin
  {
    Q_OBJECT

    /// \brief Constructor
    public: TesseractGridConfig();

    /// \brief Destructor
    public: ~TesseractGridConfig() override;
    ...
    private: std::unique_ptr<TesseractGridConfigPrivate> dataPtr;
  };
}
}
}
#endif // TESSERACT_IGNITION_TESSERACT_GRID_CONFIG_H
