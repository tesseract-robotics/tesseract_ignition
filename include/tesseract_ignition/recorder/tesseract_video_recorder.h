...
#ifndef TESSERACT_IGNITION_TESSERACT_VIDEO_RECORDER_H_
#define TESSERACT_IGNITION_TESSERACT_VIDEO_RECORDER_H_
...
namespace plugins
{
  ...
  class TesseractVideoRecorder : public ignition::gui::Plugin
  {
    Q_OBJECT

    /// \brief Constructor
    public: TesseractVideoRecorder();

    /// \brief Destructor
    public: ~TesseractVideoRecorder() override;
    ...
    private: std::unique_ptr<TesseractVideoRecorderPrivate> dataPtr;
  };
}
}
}

#endif // TESSERACT_IGNITION_TESSERACT_VIDEO_RECORDER_H_
