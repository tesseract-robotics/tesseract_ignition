...
#include <tesseract_ignition/load/tesseract_load.h>
...
/////////////////////////////////////////////////
TesseractLoad::TesseractLoad()
  : ignition::gui::Plugin()
  , data_(new TesseractLoadPrivate)
{
}
...
/////////////////////////////////////////////////
void TesseractLoad::onLoadTesseract(const QString &_urdf_filepath, const QString& _srdf_filepath)
{
...
bool TesseractLoad::eventFilter(QObject *_obj, QEvent *_event)
{
...
/////////////////////////////////////////////////
void TesseractLoad::updateTesseract()
{
  if (!(this->data_->dirty))
    return;
...
IGNITION_ADD_PLUGIN(tesseract_ignition::gui::plugins::TesseractLoad, ignition::gui::Plugin);
